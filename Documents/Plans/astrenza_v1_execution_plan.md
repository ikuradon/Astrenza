...
Status: Scaffold complete for offline tests, with the explicit-flag TimelineHome startup/restore/scroll local gate complete. Production Home default replacement remains blocked. The Home wiring strategy is documented in `Documents/Plans/timeline_home_wiring_adr.md`, and the startup/restore/scroll completion boundary is defined in `Documents/Plans/timeline_home_limited_wiring_plan.md`; both preserve default legacy startup and do not authorize production default rollout.
