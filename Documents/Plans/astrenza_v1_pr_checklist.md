...
- [ ] DB bridge changes state whether v0.2 schema remains unchanged, or include a spec-backed migration/backfill/rollback plan.
...
- [ ] DB bridge changes include either a no-schema-change note or a migration plan, and reference `Documents/Plans/timeline_db_bridge_audit.md`.
